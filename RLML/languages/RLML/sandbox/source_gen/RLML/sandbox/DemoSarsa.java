...
public class DemoSarsa {
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    DemoSarsa.IndexValue selectAction(int stateId, DemoSarsa.QModel model, Set<Integer> actionsAtState);
    DemoSarsa.IndexValue selectAction(int stateId, DemoSarsa.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
