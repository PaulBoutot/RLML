...
public class SimpleGameSARSA {
  ...
  public static void main(String[] args) {
    ...
    SimpleGameSARSA obj = new SimpleGameSARSA();
    obj.run();
  ...
  /*package*/ void saveQTableResult() {
    try {
      File qTableFile = new File("SimpleGameSARSA.txt");
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    SimpleGameSARSA.IndexValue selectAction(int stateId, SimpleGameSARSA.QModel model, Set<Integer> actionsAtState);
    SimpleGameSARSA.IndexValue selectAction(int stateId, SimpleGameSARSA.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
