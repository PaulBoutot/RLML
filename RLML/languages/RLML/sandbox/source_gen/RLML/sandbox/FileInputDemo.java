...
public class FileInputDemo {
  ...
  /*package*/ void saveQTableResult() {
    try {
      File qTableFile = new File("FileInputDemo.txt");
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    FileInputDemo.IndexValue selectAction(int stateId, FileInputDemo.QModel model, Set<Integer> actionsAtState);
    FileInputDemo.IndexValue selectAction(int stateId, FileInputDemo.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
