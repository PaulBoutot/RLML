...
public class PathfindingQlearningVsSarsa {
  ...
  public PathfindingQlearningVsSarsa() {
    init();
  }
  ...
  public static void main(String[] args) {
    PathfindingQlearningVsSarsa obj = new PathfindingQlearningVsSarsa();
    obj.run();
  }
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    PathfindingQlearningVsSarsa.IndexValue selectAction(int stateId, PathfindingQlearningVsSarsa.QModel model, Set<Integer> actionsAtState);
    PathfindingQlearningVsSarsa.IndexValue selectAction(int stateId, PathfindingQlearningVsSarsa.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
