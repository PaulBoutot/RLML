...
public class Compare_QLearningAndSarsa {
  ...
  public Compare_QLearningAndSarsa() {
    init();
  }
  ...
  private void run_algorithm_b() {
    System.out.print("Algorithm Name: ");
    System.out.println("");
    System.out.println();
    long Begin1L = System.currentTimeMillis();
    // HyperNEAT Implementation Pending
    System.out.println("THE ALGORITHM IS PENDING IMPLEMENTATION: PLEASE USE A DIFFERENT ONE");
    this.printQTableResult();
    this.showPolicy();
    long End = System.currentTimeMillis();
    System.out.println("\nTime: " + (End - Begin1L) / 1000.0 + "sec.");
  ...
  public static void main(String[] args) {
    Compare_QLearningAndSarsa obj = new Compare_QLearningAndSarsa();
    obj.run();
  }
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    Compare_QLearningAndSarsa.IndexValue selectAction(int stateId, Compare_QLearningAndSarsa.QModel model, Set<Integer> actionsAtState);
    Compare_QLearningAndSarsa.IndexValue selectAction(int stateId, Compare_QLearningAndSarsa.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
