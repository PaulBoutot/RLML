...
public class SimpleExample {
  ...
  /*package*/ void init() {
    ...
    String doneStr = "[A]".replaceAll("\\s+", "");
    doneStr = doneStr.substring(1, doneStr.length() - 1);
    doneStates = doneStr.split(",");

    rewards = strToArrArr("[[0,0],[0,1]]", rewardsArrLst);
    actions = strToArrArr("[[1],[0]]", actionsArrLst);
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    SimpleExample.IndexValue selectAction(int stateId, SimpleExample.QModel model, Set<Integer> actionsAtState);
    SimpleExample.IndexValue selectAction(int stateId, SimpleExample.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
