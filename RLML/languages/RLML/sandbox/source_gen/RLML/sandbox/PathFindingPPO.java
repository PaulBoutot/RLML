...
public class PathFindingPPO {
  ...
  public static void main(String[] args) {
    ...
    PathFindingPPO obj = new PathFindingPPO();
    obj.run();
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    PathFindingPPO.IndexValue selectAction(int stateId, PathFindingPPO.QModel model, Set<Integer> actionsAtState);
    PathFindingPPO.IndexValue selectAction(int stateId, PathFindingPPO.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
