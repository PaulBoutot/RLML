...
public class TestActorCritic {
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    TestActorCritic.IndexValue selectAction(int stateId, TestActorCritic.QModel model, Set<Integer> actionsAtState);
    TestActorCritic.IndexValue selectAction(int stateId, TestActorCritic.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
