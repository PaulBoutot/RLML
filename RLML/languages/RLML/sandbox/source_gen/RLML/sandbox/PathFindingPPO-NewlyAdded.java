...
public class PathFindingPPO-NewlyAdded {
  ...
  public PathFindingPPO-NewlyAdded() {
    init();
  }
  ...
  public static void main(String[] args) {
    ...
    PathFindingPPO-NewlyAdded obj = new PathFindingPPO-NewlyAdded();
    obj.run();
  ...
  /*package*/ interface ActionSelectionStrategy extends Serializable {
    PathFindingPPO-NewlyAdded.IndexValue selectAction(int stateId, PathFindingPPO-NewlyAdded.QModel model, Set<Integer> actionsAtState);
    PathFindingPPO-NewlyAdded.IndexValue selectAction(int stateId, PathFindingPPO-NewlyAdded.UtilityModel model, Set<Integer> actionsAtState);
    String getPrototype();
